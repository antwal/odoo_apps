...
class account_invoice(osv.osv):
    ...
    def voucher_from_invoice(self, cr, uid, invoice_id, amount,
        ...
        voucher_id = voucher_obj.create(cr, uid, {
            ...
            'date': invoice.move_id and invoice.move_id.date \
    ...
    def create_auto_invoice(self, cr, uid, ids, context=None):
        ...
        for inv in self.browse(cr, uid, ids, context):
            ...
            if line_voucher_to_be_reconcile and line_supplier_to_be_reconcile:
                reconcile_ids = [line_voucher_to_be_reconcile, line_supplier_to_be_reconcile]
                move_line_obj.reconcile_partial(cr, uid, reconcile_ids, context=context)
            ...
            voucher_autoinvoice = voucher_obj.browse(cr, uid, voucher_autoinvoice_id)
            ...
            if line_voucher_to_be_reconcile and line_autoinvoice_to_be_reconcile:
                ...
                y = move_line_obj.browse(cr, uid , line_autoinvoice_to_be_reconcile)
                if x.account_id.id != y.account_id.id:
                    raise osv.except_osv(
                        ...
                        _('Supplier and Partner Autoinvoice haven\'t the same \
                            customer account\
                        first.'))
                reconcile_ids = [line_voucher_to_be_reconcile, line_autoinvoice_to_be_reconcile]
                move_line_obj.reconcile_partial(cr, uid, reconcile_ids, context=context)
